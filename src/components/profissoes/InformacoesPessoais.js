            ...
            <img src={savings} alt="Imagem perfil" />
              ...
              <div className={styles.funcao}>
                ...
                <div className={styles.redes_sociais}>
                  <div>
                    <a href='https://www.youtube.com/' target={'_blank'}><FaYoutube size={25} /></a>
                    <a href='https://www.linkedin.com/' target={'_blank'}><FaLinkedin size={25} /></a>
                    <a href='https://github.com/' target={'_blank'}><FaGithub size={25} /></a>
                  </div>
                </div>
